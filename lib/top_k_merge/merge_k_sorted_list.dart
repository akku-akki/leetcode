void main() {
  ListNode l1 = ListNode(1, ListNode(4, ListNode(5)));
  ListNode l2 = ListNode(1, ListNode(3, ListNode(4)));
  ListNode l3 = ListNode(2, ListNode(6));
...
class Solution {
  ListNode? mergeKLists(List<ListNode?> lists) {
    final minHeap = HeapPriorityQueue<ListNode>(
      (p0, p1) => p0.val.compareTo(p1.val),
    );
    ...
    while (!minHeap.isEmpty) {
      ListNode currentNode = minHeap.removeFirst();
      if (resultHead == null) {
